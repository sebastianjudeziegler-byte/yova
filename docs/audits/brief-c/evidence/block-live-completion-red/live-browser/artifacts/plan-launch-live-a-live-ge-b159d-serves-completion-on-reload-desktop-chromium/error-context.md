...
- generic [active] [ref=f2e1]:
  - generic [ref=f2e2]:
    ...
    - banner [ref=f2e4]:
      - generic [ref=f2e5]:
        - generic [ref=f2e6]: "Y"
        - generic [ref=f2e7]: YOVA
      - navigation "Main navigation" [ref=f2e8]:
        - button "Home" [ref=f2e9] [cursor=pointer]
        - button "Learning" [ref=f2e11] [cursor=pointer]
        - button "Calendar" [ref=f2e13] [cursor=pointer]
        - button "Ask YOVA" [ref=f2e15] [cursor=pointer]
        - button "You" [ref=f2e17] [cursor=pointer]
      - generic [ref=f2e19]:
        - button "Add to YOVA" [ref=f2e20] [cursor=pointer]:
          - generic [ref=f2e22]: Add
        - generic [ref=f2e23]:
          - generic "Learner · Private alpha" [ref=f2e24]: L
          - button "Sign out on this device" [ref=f2e25] [cursor=pointer]
    - main [ref=f2e29]:
      - generic [ref=f2e30]:
        - generic [ref=f2e31]:
          - generic [ref=f2e32]: MONDAY, SEPTEMBER 7
          - heading [level=1] [ref=f2e33]:
            - text: Good afternoon,
            - emphasis [ref=f2e34]: Learner
        - generic [ref=f2e35]:
          - region "Recommended learning plan" [ref=f2e36]:
            - generic [ref=f2e37]:
              - generic [ref=f2e38]: CONTINUE · READY TO FINISH
              - heading "Build ATP and energy transfer" [level=2] [ref=f2e39]
              - generic [ref=f2e40]:
                - generic [ref=f2e41]: Learn
                - generic [ref=f2e42]: Feynman Technique
                - generic [ref=f2e43]: 10 minutes
              - paragraph [ref=f2e44]:
                - strong [ref=f2e45]: WHY THIS ·
              ...
              - paragraph [ref=f2e46]:
                - generic [ref=f2e50]:
                  - strong [ref=f2e51]: "Personalized today:"
                  - text: Example first · One step at a time · Hint first
                - button "Why?" [ref=f2e52] [cursor=pointer]
            - generic [ref=f2e53]:
              - button "Review and finish" [ref=f2e54] [cursor=pointer]
              - generic [ref=f2e55]: 0 of 1 sessions complete
          - generic [ref=f2e56]:
            - generic [ref=f2e57]:
              - heading "Today" [level=3] [ref=f2e58]
              - button "Calendar →" [ref=f2e59] [cursor=pointer]
            - generic [ref=f2e60]:
              - generic [ref=f2e61]: PM
              - generic [ref=f2e62]:
                - strong [ref=f2e63]: Build ATP and energy transfer
                - generic [ref=f2e64]: 1 topic + 1 practice check + about 10 min · up next
            - generic [ref=f2e65]:
              - generic [ref=f2e66]:
                - strong [ref=f2e67]: "0"
                - generic [ref=f2e68]: sessions completed
              - generic [ref=f2e69]:
                - strong [ref=f2e70]: "1"
                - generic [ref=f2e71]: active plan
        - generic [ref=f2e72]:
          - generic [ref=f2e73]:
            - textbox "Ask YOVA" [ref=f2e74]:
              - /placeholder: Ask YOVA about anything you're studying…
            - button "Send" [disabled] [ref=f2e75]:
              - generic [ref=f2e76]: Ask
          - button "Add plan Notes, syllabus, link" [ref=f2e77] [cursor=pointer]:
            - generic [ref=f2e78]: +
            - generic [ref=f2e79]:
              - strong [ref=f2e80]: Add plan
              - generic [ref=f2e81]: Notes, syllabus, link
            - generic [ref=f2e82]: ›
          - button "Study now Quick, off-plan" [ref=f2e83] [cursor=pointer]:
            - generic [ref=f2e84]: →
            - generic [ref=f2e85]:
              - strong [ref=f2e86]: Study now
              - generic [ref=f2e87]: Quick, off-plan
            - generic [ref=f2e88]: ›
        - generic [ref=f2e89]:
          - heading "YOVA noticed" [level=3] [ref=f2e90]
          - generic [ref=f2e91]: from your recent sessions
        - generic [ref=f2e93]:
          - generic [ref=f2e94]:
            - generic [ref=f2e95]: "Y"
            - generic [ref=f2e96]: PERSONALIZATION
          - generic [ref=f2e97]:
            - strong [ref=f2e98]: Complete one guided session so YOVA can compare your profile with real work.
            ...
            - emphasis [ref=f2e99]: No completed-session evidence yet
          - button "Start the recommended session" [ref=f2e101] [cursor=pointer]
        - generic [ref=f2e102]:
          - heading "Your week" [level=3] [ref=f2e103]
          - generic [ref=f2e104]: Sep 7 – 11
        - generic [ref=f2e105]:
          - generic [ref=f2e106]:
            - generic [ref=f2e107]: MON · TODAY
            - strong [ref=f2e108]: Build ATP and energy transfer
            - generic [ref=f2e109]: 10 min · 1 session
          - generic [ref=f2e110]:
            - generic [ref=f2e111]: TUE
            - strong [ref=f2e112]: Open
            - generic [ref=f2e113]: nothing scheduled
          - generic [ref=f2e114]:
            - generic [ref=f2e115]: WED
            - strong [ref=f2e116]: Open
            - generic [ref=f2e117]: nothing scheduled
          - generic [ref=f2e118]:
            - generic [ref=f2e119]: THU
            - strong [ref=f2e120]: Open
            - generic [ref=f2e121]: nothing scheduled
          - generic [ref=f2e122]:
            - generic [ref=f2e123]: FRI
            - strong [ref=f2e124]: Open
            - generic [ref=f2e125]: nothing scheduled
        - generic [ref=f2e126]:
          - heading "Pick up where you left off" [level=3] [ref=f2e127]
          - generic [ref=f2e128]: 1 open thread
        - generic [ref=f2e130]:
          - generic [ref=f2e131]: TEACH ME CELLULAR RESPIRATION FROM SCRATCH FOR MY TEST, INCLUDING ATP…
          - strong [ref=f2e132]: Build ATP and energy transfer
          - generic [ref=f2e133]: 4 of 4 sections saved
          - generic [ref=f2e134]: 100%
          - button "Resume" [ref=f2e138] [cursor=pointer]
        - generic [ref=f2e139]:
          - heading "Where you stand" [level=3] [ref=f2e140]
          - generic [ref=f2e141]: updates after every session
        - 'button "Teach Me Cellular Respiration From Scratch for My Test, Including ATP… 0% 0 of 1 topics secure · next: atp and energy transfer" [ref=f2e143] [cursor=pointer]':
          - generic [ref=f2e144]:
            - strong [ref=f2e145]: Teach Me Cellular Respiration From Scratch for My Test, Including ATP…
            - generic [ref=f2e146]: 0%
          - generic [ref=f2e147]: "0 of 1 topics secure · next: atp and energy transfer"
        - generic [ref=f2e148]:
          - heading "Your learning" [level=3] [ref=f2e149]
          - generic [ref=f2e150]: 1 active
        - button "Teach Me Cellular Respiration From Scratch for My Test, Including ATP… Continue at section 4" [ref=f2e152] [cursor=pointer]:
          - generic [ref=f2e166]:
            - strong [ref=f2e167]: Teach Me Cellular Respiration From Scratch for My Test, Including ATP…
            - generic [ref=f2e168]: Continue at section 4
    - contentinfo [ref=f2e171]:
      - navigation "Trust and support" [ref=f2e172]:
        - link "Support" [ref=f2e173] [cursor=pointer]:
          - /url: /support
        - link "Privacy" [ref=f2e174] [cursor=pointer]:
          - /url: /privacy
        - link "Terms" [ref=f2e175] [cursor=pointer]:
          - /url: /terms
  - button "Open Next.js Dev Tools" [ref=f2e181] [cursor=pointer]
  - alert [ref=f2e185]
```
