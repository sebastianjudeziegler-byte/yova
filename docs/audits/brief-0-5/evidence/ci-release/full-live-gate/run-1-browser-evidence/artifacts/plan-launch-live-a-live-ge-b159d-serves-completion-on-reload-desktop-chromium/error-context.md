        ...
        - generic [ref=f1e45]:
          - generic [ref=f1e46]:
            - generic [ref=f1e47]:
              ...
              - strong [ref=f1e49]: Explain ATP in your own words
            - generic [ref=f1e50]: About 2 min
          - heading "What does ATP do?" [level=1] [ref=f1e54]
          - paragraph [ref=f1e56]: Explain ATP from memory in 2 to 4 sentences. Keep it concrete.
        - generic [ref=f1e57]:
          - generic [ref=f1e60]:
            - generic [ref=f1e61]: PREVIOUS LESSON AVAILABLE
            - strong [ref=f1e62]: What Does ATP Do?
          ...
          - generic [ref=f1e69]:
            - generic [ref=f1e70]:
              ...
              - generic [ref=f1e79]:
                ...
                - list [ref=f1e80]:
                  - listitem [ref=f1e81]: The relationship involving “stores” is still missing.
                  - listitem [ref=f1e82]: The relationship involving “usable” is still missing.
            - generic [ref=f1e83]:
              - text: YOUR ATTEMPT
              - paragraph [ref=f1e85]: ATP hydrolysis forms ADP and inorganic phosphate. This reaction releases free energy that can be coupled to cellular work.
            - generic [ref=f1e86]:
              - text: MODEL ANSWER
              - paragraph [ref=f1e88]: ATP stores usable energy in its phosphate bonds and transfers that energy when a phosphate is removed or added in a cell.
              - group [ref=f1e89]:
                - generic "What this answer needs to show" [ref=f1e90] [cursor=pointer]
            - generic [ref=f1e91]: YOVA did not record a correct or incorrect result from this check. Continue after comparing with the model answer.
            - text: Your typed answer is not saved, and this uncertain or unavailable check created no concept or method evidence.
        - button "Continue" [ref=f1e94] [cursor=pointer]
    - complementary [ref=f1e97]:
      - button "Ask YOVA" [ref=f1e98] [cursor=pointer]
```
