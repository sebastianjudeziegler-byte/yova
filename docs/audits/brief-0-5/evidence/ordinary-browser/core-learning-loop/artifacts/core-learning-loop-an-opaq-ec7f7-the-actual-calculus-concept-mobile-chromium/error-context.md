...
- Name: core-learning-loop.spec.ts >> an opaque class label is stopped until the learner names the actual calculus concept
- Location: e2e/core-learning-loop.spec.ts:695:5
