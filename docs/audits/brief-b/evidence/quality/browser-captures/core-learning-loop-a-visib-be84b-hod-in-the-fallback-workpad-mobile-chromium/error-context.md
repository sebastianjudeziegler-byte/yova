...
- Name: core-learning-loop.spec.ts >> a visibly shortened inside recipe keeps its method in the fallback workpad
- Location: e2e/core-learning-loop.spec.ts:468:5
...
- main:
  ...
  - text: SKILL · FLEXIBLE
  - heading "Review the Product Rule and Test What I Remember" [level=2]
  - paragraph: Review the product rule and test what I remember
  ...
  - list:
    - listitem:
      - text: "1"
      - strong: The product rule for derivatives
      - text: Not started
      - paragraph: The knowledge and performance needed for The product rule for derivatives.
  ...
  - text: 1 sessions
  - strong: Practice The product rule for derivatives
  - text: Practice first · Practice Problems · Wed 5:00 PM 10 min
...
- contentinfo:
  - navigation "Trust and support":
    ...
    - link "Terms":
      - /url: /terms
- dialog "Start Practice The product rule for derivatives now?":
  - text: YOU ARE AHEAD OF SCHEDULE
  - heading "Start Practice The product rule for derivatives now?" [level=2]
