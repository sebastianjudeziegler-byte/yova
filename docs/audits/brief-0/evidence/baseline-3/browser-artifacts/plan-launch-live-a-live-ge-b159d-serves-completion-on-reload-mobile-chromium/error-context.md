        ...
        - generic [ref=f1e40]:
          - generic [ref=f1e41]:
            - generic [ref=f1e42]:
              ...
              - strong [ref=f1e44]: Explain
            - generic [ref=f1e45]: About 2 min
          - heading "ATP energy transfer" [level=1] [ref=f1e49]
          - paragraph [ref=f1e51]: How does ATP contribute usable energy in cellular respiration?
        - generic [ref=f1e52]:
          - generic [ref=f1e55]:
            - generic [ref=f1e56]: PREVIOUS LESSON AVAILABLE
            - strong [ref=f1e57]: ATP Energy Transfer
            ...
            - generic [ref=f1e65]:
              ...
              - generic [ref=f1e70]:
                ...
                - list [ref=f1e71]:
                  ...
                  - listitem [ref=f1e74]: You included the idea connected to “work.”
              - generic [ref=f1e75]:
                - text: What is still missing
                - list [ref=f1e76]:
                  - listitem [ref=f1e77]: The relationship involving “contributes” is still missing.
                  - listitem [ref=f1e78]: The relationship involving “usable” is still missing.
            - generic [ref=f1e79]:
              - text: YOUR ATTEMPT
              - paragraph [ref=f1e81]: ATP hydrolysis forms ADP and inorganic phosphate. This reaction releases free energy that can be coupled to cellular work.
            - generic [ref=f1e82]:
              - text: MODEL ANSWER
              - paragraph [ref=f1e84]: ATP contributes usable energy when its terminal phosphate bond is hydrolyzed, releasing energy that cells can use for work.
              - group [ref=f1e85]:
                - generic "What this answer needs to show" [ref=f1e86] [cursor=pointer]
            - generic [ref=f1e87]: YOVA did not record a correct or incorrect result from this check. Continue after comparing with the model answer.
            - text: Your typed answer is not saved, and this uncertain or unavailable check created no concept or method evidence.
        - button "Continue" [ref=f1e90] [cursor=pointer]
    - complementary [ref=f1e93]:
      - button "Ask YOVA" [ref=f1e94] [cursor=pointer]
```
