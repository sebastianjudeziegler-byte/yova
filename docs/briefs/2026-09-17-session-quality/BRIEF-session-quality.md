...
This brief accompanies the three supplied [Brief 2 files](supplied-brief-2/). It does not replace their plan model. Read [OWNERSHIP-AND-EXECUTION.md](OWNERSHIP-AND-EXECUTION.md) before implementation.
