...
export const metadata: Metadata = {
  title: "Alpha Terms · YOVA",
  description: "The current terms for using the YOVA alpha.",
  alternates: { canonical: "/terms" },
};

export default function TermsPage() {
  return <TrustPage eyebrow="YOVA ALPHA TERMS" title="A learning tool, not a promise of results." summary="These terms set straightforward expectations while YOVA is being tested and improved.">
    ...
    <section><h2>2. What YOVA provides</h2><p>YOVA creates educational plans, resources, guided sessions, and tutoring assistance. The alpha may change, become unavailable, produce errors, or lose features as testing continues. Access is currently offered for evaluation and may be limited or ended.</p></section>
    ...
    <section><h2>6. Availability and responsibility</h2><p>The alpha is provided on an “as available” basis. To the extent permitted by law, YOVA is not responsible for indirect losses caused by relying on generated content, missed deadlines, service interruptions, or loss of access. Nothing here limits rights that cannot legally be limited.</p></section>
