...
export default function TermsPage() {
  return <TrustPage eyebrow="YOVA TERMS" title="A learning tool, not a promise of results." summary="These terms set straightforward expectations while YOVA is being tested and improved." updated="September 4, 2026">
