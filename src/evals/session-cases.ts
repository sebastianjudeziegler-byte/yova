...
export function buildSessionEvaluationCases(): SessionEvaluationCase[] {
  return [
    ...
    evaluationCase({
      id: "chemistry_temperature_reaction_rate_15_min",
      label: "Fifteen-minute temperature and reaction-rate explanation",
      taskFamily: "conceptual",
      expectedSourceTerms: [],
      context: {
        sessionArchitectureVersion: "streamed_teaching_v1",
        learningGoal: {
          title: "Temperature and chemical reaction rate",
          topic: "Why increasing temperature usually speeds up a chemical reaction",
          kind: "topic",
          deadline: null,
          sourceMode: "yova_generated",
          studyMode: "inside_yova",
        ...
        planRationale: "Build the particle-level causal model first, then ask for a short explanation without the model visible.",
        materials: [],
        knowledgeTopics: [{
          id: "8ec325f4-0000-4000-8000-000000000007",
          title: "Activation energy and successful collisions",
          description: "Reacting particles must collide with enough energy to overcome the activation-energy barrier.",
          subtopics: ["activation energy", "successful collisions"],
          prerequisiteTopicIds: [],
          status: "not_started",
          initialEvidence: null,
          sourceReferences: [],
          ...
          id: "8ec325f4-0000-4000-8000-000000000008",
          title: "Why higher temperature increases reaction rate",
          description: "Higher temperature raises particle kinetic energy, increasing the frequency and energetic success of collisions.",
          subtopics: ["particle motion", "collision frequency", "energy distribution"],
          prerequisiteTopicIds: ["8ec325f4-0000-4000-8000-000000000007"],
          status: "not_started",
          initialEvidence: null,
          sourceReferences: [],
          origin: "ai_generated",
        ...
        session: {
          title: "Explain why temperature changes reaction rate",
          objective: "Explain why increasing temperature usually speeds up a chemical reaction, then use the particle-level model to explain the effect in your own words.",
          method: "Feynman Technique",
          methodReason: "A concise model followed by explanation, repair, and re-explanation makes the causal gap visible.",
          estimatedMinutes: 15,
          learningMode: "learn",
          topicIds: [
            "8ec325f4-0000-4000-8000-000000000007",
            "8ec325f4-0000-4000-8000-000000000008",
          ],
          contentTargets: [
          ...
          completionEvidence: [
            "Explain the particle-level causal chain without reopening the model",
          ],
        },
        learnerProfile: null,
        sessionAdjustment: null,
