...
const strongSession = GeneratedSessionDraftSchema.parse({
  ...
  activities: [
    ...
    },
    {
      ...
      label: "Explain",
      title: "Explain where glycolysis begins",
      body: "Without looking, explain where glycolysis begins and how it fits into cellular respiration.",
      teaching: null,
      choices: [],
      correctAnswer: "Glycolysis begins in the cytoplasm before later stages of cellular respiration continue in the mitochondria.",
      feedback: "A strong explanation places glycolysis in the cytoplasm and connects it to the later mitochondrial stages.",
    },
    {
      topicId: null,
      methodPhase: "repair",
      ...
      concept: null,
      label: "Repair",
      title: "Compare and repair the model",
      body: "Compare your explanation with the notes. Repair any confusion between storing light energy in glucose and releasing that energy into ATP.",
      teaching: null,
      choices: [],
      correctAnswer: null,
      feedback: null,
    },
    {
      ...
      label: "Explain again",
      title: "Teach back the repaired relationship",
      body: "Close the notes and explain again how photosynthesis and cellular respiration differ in their energy transformations.",
      teaching: null,
      choices: [],
...
describe("session quality rubric", () => {
  ...
  it("accepts two focused retrieval checks plus a delayed return for a study session", () => {
    const studySession = GeneratedSessionDraftSchema.parse({
      ...
      activities: [
        { ...strongSession.activities[1], methodPhase: "retrieve" },
        { ...strongSession.activities[3], methodPhase: "retrieve" },
        {
          topicId: null,
          methodPhase: "schedule_return",
          estimatedMinutes: 1,
