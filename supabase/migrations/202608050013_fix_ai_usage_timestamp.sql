-- PostgreSQL treats current_time as a built-in time value. Using that name for
-- our timestamptz variable made date_trunc resolve the wrong type during the
-- durable AI-usage check.
