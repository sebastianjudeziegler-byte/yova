-- Lesson skip events share the privacy-safe generation observation channel,
-- but they are usage facts rather than provider generations. Keep reliability
-- denominators limited to actual generation attempts.
