...
select extensions.is(public.signed_in_generation_readiness_v6()->>'contractVersion','20260919100001',
  'the existing v6 RPC advertises the current migration contract');
